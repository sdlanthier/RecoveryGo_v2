...
public class Entry implements Parcelable{
    ...
    private String name, street, city, prov, pcode, phone, web, bedsttl, bedsrepair, bedspublic, waittime, gender, nextavail;

    private @ServerTimestamp
    Date timestamp;
    private String entry_id;

    public Entry(String name, String street, String city, String prov, String pcode,
    ...
    public String getBedsrepair() { return bedsrepair; } public void setBedsrepair(String bedsrepair) { this.bedsrepair = bedsrepair; }
    public String getBedspublic() { return bedspublic; } public void setBedspublic(String bedspublic) { this.bedspublic = bedspublic; }
    public String getWaittime() { return waittime; } public void setWaittime(String waittime) { this.waittime = waittime; }
